...
var fight = function(enemy) {
        // coin flip variable, keep track of who goes first
    var isPlayerTurn = true;    
        // Method to create a conditional statement that will reassign the isPlayerTurn to false half of the time.     
    if (Math.random() > 0.5) {
        isPlayerTurn = false;
    }
...
var startGame = function() {
    ...
    for (var i = 0; i < enemyInfo.length; i++) {        // 'i++' OR 'i = i + 1'
        if (playerInfo.health > 0) {
            ...
            window.alert("Welcome to Robot Gladiators! Round " + (i + 1));
                ...
                // Pick new enemy to fight based on the index of the enemy Object array.
            ...
            pickedEnemyObj.health = randomNumber(40, 60);
                ...
                // Pass the Object Property value into the fight function, where it will assume the value of the enemyName parameter.
    ...
    // Endgame Call: after the loop ends, player is either out of health or enemies to fight, so run the endGame function
  endGame();
};
...
var shop = function() {
    ...
    shopOptionPrompt = parseInt(shopOptionPrompt);
        // use switch case statements to carry out action
    ...
    // Function to enter a valid 'name' response in prompt.
var getPlayerName = function() {
    ...
    // Array (Custom Object)
var playerInfo = {
    name: getPlayerName(),  // Call for getPlayerName() function^^
    health: 100,
    attack: 10,
    money: 10,
